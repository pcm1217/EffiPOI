...
def parse_args():
    ...
    parser.add_argument('--plm_size', type=int, default=1664)

    # PQ
    parser.add_argument("--subvector_num", type=int, default=128, help='32/64/128')
    parser.add_argument("--n_centroid", type=int, default=4, help='2/4/8')
    parser.add_argument("--use_gpu", type=int, default=None)
